...
def plot_sales_report(
    ...
    ax2 = ax1.twinx()
    ax2.set_ylabel("Total Net Total", color="tab:orange")
    ax2.plot(dates, total_net_total, color="tab:orange", label="Total Net Total",marker='o')
    ax2.set_ylim(ymin=0)
...
def plot_inventory_cost_report(inventory_report: Dict[str, Dict[str, float]],
    ...
    # Create a second y-axis for total net total
    ax2 = ax1.twinx()
    ax2.set_ylabel("Total Cost", color="tab:orange")
    ax2.plot(dates, total_net_total, color="tab:orange", label="Total Cost",marker='o')
    ax2.set_ylim(ymin=0)
    ax2.tick_params(axis="y", labelcolor="tab:orange")
    ax2.legend(loc="upper right")
